### Analyse frequentielle exploratoire.
### Ici on regarde le contenu en frequences des traces avant/apres preprocessing.

### Importations: ce fichier vient d'un workflow exploratoire, mais on garde les blocs lisibles.
import numpy as np
import pandas as pd
...
from maitrise_curbd.timeseries import (
    ...
    compute_mean_autocorrelation,
    estimate_autocorrelation_timescale,
    extract_timeseries_du_tenseur, regress_out_global_signal
)
...
#########################################################################################################
### SETUP: souris, resolution spatiale et parametres de preprocessing.
##########################################################################################################
...
#########################################################################################################
### Preworkout: charger les donnees et construire les sous-regions.
##########################################################################################################
...
### On clean le masque et on le reduit aux grandes regions avant de subdiviser.
...
### Building du dictionnaire de regions parentes: utile si on compare avec CURBD apres.
regions = build_parent_regions_dict(info_masque_sub)

### A la chasse aux petites regions: check rapide pour detecter un mauvais clustering.
...
### Extraction des timeseries regionales, le vrai input de l'analyse frequencielle.
...
### Les fichiers GCaMP recus sont deja en DeltaF/F. Pas de double DFF, sinon ca part en vrille.

### Régression globale optionnelle.
