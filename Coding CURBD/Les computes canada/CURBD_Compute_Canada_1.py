...
for N_used in N_list :
    ...
    np.save(fr'/home/pllar11/scratch/J_list_{N_used}-V2.npy', J_list)
    np.save(fr'/home/pllar11/scratch/J_{N_used}-V2.npy', J)
    np.save(fr'/home/pllar11/scratch/x_list_{N_used}-V2.npy', x_list)