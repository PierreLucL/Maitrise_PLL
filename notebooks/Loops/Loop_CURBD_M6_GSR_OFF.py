...
#
datasets = [
    # 361 était en cours lorsque le run a été interrompu
    (5, 6, 361),
...
titre_du_test = "TRAIN_M6_toutes_souris_GSR_OFF"
...
for i_dataset, (
    ...
    save_path = (
        ...
        / (
            ...
            f"P0{P0:.2f}_"
            f"GSR{use_global_regression}_nRunTrain{nRunTrain}.pkl"
        )
    )
