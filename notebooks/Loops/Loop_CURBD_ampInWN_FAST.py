...
titre_du_test = "FAST_screening_ampInWN_g08_tauRNN033_dtFactor2_sigma2"
...
for i, ampInWN in enumerate(configs):
...
for i_config, ampInWN in enumerate(configs):
    ...
    row = {
        ...
        "n_pixels": n_pixels,
        "n_subregions": ts_preprocessed.shape[0],
