...
#
datasets = [
    # Mets ici toutes les souris M6 que tu veux tester.
    # Je garde les deux validées et je te laisse ajouter les autres
    # avec leur cohorte exacte.
    (8, 6, 409),
    (5, 6, 361),

    # Exemples à compléter avec la bonne cohorte :
    # (X, 6, 316),
    # (X, 6, 351),
    # (X, 6, 387),
    # (X, 6, 396),
...
titre_du_test = "TRAIN_M6_multisouris_parametres_fixes"
