...
titre_du_test = "OVERNIGHT_convergence_1000runs_6souris"
...
for i_dataset, (
    ...
    try:
        ...
        # Points de convergence : run 100 = indice 99, etc.
        row["pVar_run_100"] = safe_index(
            pVar,
            99,
        )

        row["pVar_run_200"] = safe_index(
            pVar,
            199,
        )

        row["pVar_run_500"] = safe_index(
            pVar,
            499,
        )

        row["pVar_run_750"] = safe_index(
            pVar,
            749,
        )

        row["pVar_run_1000"] = safe_index(
            pVar,
            999,
        )
        ...
        print(
            "Convergence pVar : "
            f"100={row['pVar_run_100']:.4f} | "
            f"200={row['pVar_run_200']:.4f} | "
            f"500={row['pVar_run_500']:.4f} | "
            f"750={row['pVar_run_750']:.4f} | "
            f"1000={row['pVar_run_1000']:.4f}"
        )
